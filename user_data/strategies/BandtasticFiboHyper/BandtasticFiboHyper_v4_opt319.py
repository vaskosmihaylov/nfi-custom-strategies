...
# 319/1000:    412 trades. 251/35/126 Wins/Draws/Losses. 
# Avg profit   0.41%. 
# Median profit   0.67%. 
# Total profit 380.13419660 USDT (  38.01%). 
# Avg duration 2:02:00 min. 
# Objective: 1.35893
# max_open_trades = 5
class BandtasticFiboHyper_v4_opt319(IStrategy):
    INTERFACE_VERSION = 3
    can_short = True
    timeframe = '5m'
    ...
    # ========= 杠杆参数 =========
    max_leverage = DecimalParameter(1.0, 5.0, default=2.062, space='protection', optimize=False)
    max_short_leverage = DecimalParameter(1.0, 3.0, default=2.522, space='protection', optimize=False)
    atr_threshold_low = DecimalParameter(0.005, 0.03, default=0.007, space='protection', optimize=False)
    atr_threshold_high = DecimalParameter(0.02, 0.08, default=0.074, space='protection', optimize=False)

    # ========= long 参数 =========
    buy_fastema = IntParameter(1, 236, default=70, space='buy', optimize=False)
    buy_slowema = IntParameter(1, 250, default=40, space='buy', optimize=False)
    buy_rsi = IntParameter(15, 70, default=35, space='buy', optimize=False)
    buy_mfi = IntParameter(15, 70, default=51, space='buy', optimize=False)
    buy_rsi_enabled = CategoricalParameter([True, False], default=False, space='buy', optimize=False)
    buy_mfi_enabled = CategoricalParameter([True, False], default=True, space='buy', optimize=False)
    buy_ema_enabled = CategoricalParameter([True, False], default=True, space='buy', optimize=False)
    buy_trigger = CategoricalParameter(['bb_lower1', 'bb_lower2', 'bb_lower3', 'bb_lower4', 'fibonacci'], default='bb_lower1', space='buy', optimize=False)
    buy_fib_enabled = CategoricalParameter([True, False], default=False, space='buy', optimize=False)
    buy_fib_level = CategoricalParameter(['fib_236', 'fib_382', 'fib_5', 'fib_618', 'fib_786'], default='fib_618', space='buy', optimize=False)

    # ====== Short 参数 ==========
    short_fastema = IntParameter(1, 250, default=124, space='sell', optimize=False)
    short_slowema = IntParameter(1, 250, default=139, space='sell', optimize=False)
    short_rsi = IntParameter(30, 100, default=58, space='sell', optimize=False)
    short_mfi = IntParameter(30, 100, default=42, space='sell', optimize=False)
    short_rsi_enabled = CategoricalParameter([True, False], default=True, space='sell', optimize=False)
    short_mfi_enabled = CategoricalParameter([True, False], default=False, space='sell', optimize=False)
    short_ema_enabled = CategoricalParameter([True, False], default=True, space='sell', optimize=False)
    short_trigger = CategoricalParameter(['bb_upper1', 'bb_upper2', 'bb_upper3', 'bb_upper4'], default='bb_upper1', space='sell', optimize=False)

    # ========= Sell 参数 =========
    sell_fastema = IntParameter(1, 365, default=212, space='sell', optimize=False)
    sell_slowema = IntParameter(1, 365, default=102, space='sell', optimize=False)
    sell_rsi = IntParameter(30, 100, default=93, space='sell', optimize=False)
    sell_mfi = IntParameter(30, 100, default=54, space='sell', optimize=False)
    sell_rsi_enabled = CategoricalParameter([True, False], default=False, space='sell', optimize=False)
    sell_mfi_enabled = CategoricalParameter([True, False], default=True, space='sell', optimize=False)
    sell_ema_enabled = CategoricalParameter([True, False], default=False, space='sell', optimize=False)
    sell_trigger = CategoricalParameter(['sell-bb_upper1', 'sell-bb_upper2', 'sell-bb_upper3', 'sell-bb_upper4'], default='sell-bb_upper1', space='sell', optimize=False)
    
    cover_fastema = IntParameter(1, 250, default=204, space='buy', optimize=False)
    cover_slowema = IntParameter(1, 250, default=177, space='buy', optimize=False)
    cover_rsi = IntParameter(10, 70, default=64, space='buy', optimize=False)
    cover_mfi = IntParameter(10, 70, default=54, space='buy', optimize=False)
    cover_rsi_enabled = CategoricalParameter([True, False], default=True, space='buy', optimize=False)
    cover_mfi_enabled = CategoricalParameter([True, False], default=True, space='buy', optimize=False)
    cover_ema_enabled = CategoricalParameter([True, False], default=True, space='buy', optimize=False)
    cover_trigger = CategoricalParameter(['bb_lower1', 'bb_lower2', 'bb_lower3', 'bb_lower4', 'fibonacci'], default='bb_lower2', space='buy', optimize=False)
    cover_fib_enabled = CategoricalParameter([True, False], default=False, space='buy', optimize=False)
    cover_fib_level = CategoricalParameter(['fib_236', 'fib_382', 'fib_5', 'fib_618', 'fib_786'], default='fib_618', space='buy', optimize=False)
