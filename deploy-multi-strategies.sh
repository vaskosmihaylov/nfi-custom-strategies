...
show_help() {
    ...
    echo "  nfi-x7, fastsupertrend_rsi_70, e0v1e_binance, e0v1e_binance_shorts, binhv27,"
    echo "  fibonacciematrend, gnf_v2, simplersi,"
    echo "  simplersi_shorts,"
    ...
    echo "  devdsl2approx, momentumccitrendstrategy, combinedbinhandclucv8,"
    echo "  newstrategy4_dca, osirisxrsi,"
    echo "  advancedfuturesswingstrategy"
    echo ""
    echo "Examples:"
    ...
    echo "  GnF_V2:                http://freq.gaiaderma.com/gnf_v2"
    ...
    echo "  AlexBattleTankKillerV4: http://freq.gaiaderma.com/alexbattletankkiller_v4"
    ...
    echo "  MomentumCCITrendStrategy: http://freq.gaiaderma.com/momentumccitrendstrategy"
    ...
    echo "  AdvancedFuturesSwingStrategy: http://freq.gaiaderma.com/advancedfuturesswingstrategy"
...
health_check() {
    ...
    local strategies=(
        ...
        "fenix:8129"
        "simplersi_shorts:8130"
        "mtfscalper:8131"
        "alexbattletankkiller_v4:8132"
        "triplesupertrendadxrsi:8134"
        "best5m:8135"
        "devdsl2approx:8136"
        "momentumccitrendstrategy:8137"
        "combinedbinhandclucv8:8139"
        "newstrategy4_dca:8141"
        "osirisxrsi:8142"
        "advancedfuturesswingstrategy:8143"
    )
