...
show_help() {
    ...
    echo "  fastsupertrend, machetev8b, elliotv5_sma, binclucmadv1,"
    echo "  nasosv4, martyema, ichimoku, bigwill"
    echo ""
    echo "Examples:"
    ...
    echo "  FastSupertrend: http://freq.gaiaderma.com/fastsupertrend"
