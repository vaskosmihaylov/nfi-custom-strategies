...
show_help() {
    ...
    echo "  auto_ei_t4c0s, fibonacciematrend, gnf_v2, zaratustrav31,"
    echo "  zaratustra,"
    ...
    echo "  devdsl2approx, edtma, combinedbinhandclucv8,"
    ...
    echo "  ZaratustraV31:         http://freq.gaiaderma.com/zaratustrav31"
