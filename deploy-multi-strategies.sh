...
show_help() {
    ...
    echo "  genestrategy_v2, genestrategy_v2_shorts, alexnexusforgev8aiv2, alexnexusforgev7,"
    ...
    echo "  AlexNexusForgeV8AIV2:  http://freq.gaiaderma.com/alexnexusforgev8aiv2"
    echo "  AlexNexusForgeV7:      http://freq.gaiaderma.com/alexnexusforgev7"
...
health_check() {
    ...
    local strategies=(
        ...
        "alexnexusforgev8aiv2:8112"
        "alexnexusforgev7:8113"
        "kamafama:8091"
